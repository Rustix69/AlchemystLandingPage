...
export const IconHeadset = ({ className = "w-6 h-6" }: IconProps) => (
  <svg 
...
export const IconBrain = ({ className = "w-6 h-6" }: IconProps) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 24 24" 
    fill="none" 
...
export const IconShoppingBag = ({ className = "w-6 h-6" }: IconProps) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 24 24" 
    fill="none" 
